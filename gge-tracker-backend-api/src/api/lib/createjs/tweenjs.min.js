  ...
  (function () {
    ...
    ((Ticker.init = function () {
      ...
      (Ticker.getMeasuredFPS = function (a) {
        ...
        return !b || b.length < 2
          ? -1
          : ((a = Math.min(b.length - 1, a || 0 | Ticker._getFPS())), 1e3 / ((b[0] - b[a]) / a));
      }),
      ...
      (Ticker._handleSynch = function () {
        ((Ticker._timerId = null),
          Ticker._setupTick(),
          Ticker._getTime() - Ticker._lastTime >= 0.97 * (Ticker._interval - 1) && Ticker._tick());
      }),
      ...
      (Ticker._setupTick = function () {
        if (null == Ticker._timerId) {
          ...
          if (a == Ticker.RAF_SYNCHED || a == Ticker.RAF) {
            ...
            if (b)
              return (
                (Ticker._timerId = b(a == Ticker.RAF ? Ticker._handleRAF : Ticker._handleSynch)),
                void (Ticker._raf = !0)
              );
          }
    ...
    var b = globalThis,
      c =
        b.performance.now ||
        b.performance.mozNow ||
        b.performance.msNow ||
        b.performance.oNow ||
        b.performance.webkitNow;
    ((Ticker._getTime = function () {
      return ((c && c.call(b.performance)) || Date.now()) - Ticker._startTime;
    }),
  ...
  (function () {
    ...
    try {
      Object.defineProperties(a, {
        paused: { set: a._setPaused, get: a._getPaused },
        currentLabel: { get: a._getCurrentLabel },
      });
    } catch {}
  ...
  (function () {
    ...
    function Tween(b, c) {
      (this.AbstractTween_constructor(c),
        ...
        (this.target = b),
        (this.passive = !1),
        (this._stepHead = new a(null, 0, 0, {}, null, !0)),
        ...
        (this._injected = null),
        c && ((this.pluginData = c.pluginData), c.override && Tween.removeTweens(b)),
    ...
    ((Tween.IGNORE = {}),
      ...
      (Tween._installPlugin = function (a) {
        for (
          var b = (a.priority = a.priority || 0), c = (Tween._plugins = Tween._plugins || []), d = 0, e = c.length;
          e > d && !(b < c[d].priority);
          d++
        );
        c.splice(d, 0, a);
      ...
      (Tween._register = function (a, b) {
        ...
        if (!b && a._paused) {
          ...
          (d ? ((Tween._tweenTail = d._next = a), (a._prev = d)) : (Tween._tweenHead = Tween._tweenTail = a),
            !Tween._inited &&
              createjs.Ticker &&
              (createjs.Ticker.addEventListener("tick", Tween), (Tween._inited = !0)));
        } else if (b && !a._paused) {
          c && c.tweenjs_count--;
          var e = a._next,
            f = a._prev;
          (e ? (e._prev = f) : (Tween._tweenTail = f),
            f ? (f._next = e) : (Tween._tweenHead = e),
      ...
      (c._updateTargetProps = function (a, b, c) {
        if (!(this.passive = !!a.passive)) {
          ...
          var index_ = this._plugins;
          a: for (var k in h) {
            if (
              ((e = h[k]),
              (f = index[k]),
              (d = e !== f && "number" == typeof e ? e + (f - e) * b : b >= 1 ? f : e),
              index_)
            )
              for (var l = 0, m = index_.length; m > l; l++) {
                var n = index_[l].change(this, a, k, d, b, c);
      ...
      (c._appendProps = function (a, b, c) {
        var d,
          ...
          o = {};
        for (d in a)
          if (a.hasOwnProperty(d) && ((o[d] = n[d] = a[d]), void 0 === index[d])) {
            if (((g = void 0), k))
            ...
            g !== Tween.IGNORE && (void 0 === g && (g = index_[d]), (m[d] = void 0 === g ? null : g));
          }
        for (d in o) {
          f = a[d];
  ...
  (function () {
    ...
    ((a.priority = 0),
      ...
      (a.step = function (b, c, d) {
        for (var e in d)
          if ("guide" === e) {
            ...
            var index = void 0 === c.prev.props.rotation ? b.target.rotation || 0 : c.prev.props.rotation;
            if (((f.startOffsetRot = index - f.startData.rotation), "fixed" == f.orient))
              ((f.endAbsRot = h.rotation + f.startOffsetRot), (f.deltaRotation = 0));
            else {
              var index_ = void 0 === d.rotation ? b.target.rotation || 0 : d.rotation,
      ...
      (a.change = function (b, c, d, e, f) {
        var g = c.props.guide;
        if (g && c.props !== c.prev.props && g !== c.prev.props.guide)
          return ("guide" === d && !g.valid) || "x" == d || "y" == d || ("rotation" === d && g.orient)
            ? createjs.Tween.IGNORE
            : void a._ratioToPositionData(f, g, b.target);
      }),
      (a.debug = function (b, c, d) {
        ...
        if (d && k) {
          ...
          for (var f = 0; k > f; f++)
            ((l.orient = "fixed"),
              a._ratioToPositionData(d[f], l, m),
              c.beginPath(),
              c.moveTo(m.x, m.y),
              c.lineTo(
      ...
      (a._solveGuideData = function (b, c) {
        ...
        for (f = e[0], g = e[1], l = 2; o > l; l += 4) {
          ...
          var r = { weightings: [], estLength: 0, portion: 0 },
            ...
            t = g;
          for (m = 1; p >= m; m++) {
            a._getParamsForCurve(f, g, h, index, index_, k, m / p, !1, q);
            var u = q.x - s,
              v = q.y - t;
        ...
        (a._ratioToPositionData(x, c, c.startData),
          a._ratioToPositionData(y, c, c.endData),
          (c.startData.ratio = x),
          (c.endData.ratio = y),
      ...
      (a._ratioToPositionData = function (b, c, d) {
        ...
        return (
          ...
          c.orient &&
            (b >= 0.999_99 && 1.000_01 >= b && void 0 !== c.endAbsRot
              ? (d.rotation = c.endAbsRot)
              : (d.rotation += c.startOffsetRot + b * c.deltaRotation)),
          d
        );
      }),
      (a._getParamsForCurve = function (a, b, c, d, e, f, g, h, index) {
        var index_ = 1 - g;
