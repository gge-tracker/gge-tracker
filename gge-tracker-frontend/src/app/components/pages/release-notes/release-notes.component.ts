  ...
  public readonly releaseNotes = [
    {
      ...
      items: [
        ...
        '🛠️ [Alliance Analysis] Distance calculator now supports kingdom selection',
        '🛠️ [Fortress] Added a new indicator: observed availability (average availability time before attack)',
        '🛠️ [Fortress] Added player attack history in table and chart format',
        ...
        '🐞 [Bugfix] Fixed EP-WORLD1 and EP-WORLD2 outer realm server names displayed incorrectly (shown as LIVE / LIVE2)',
        '🐞 [Bugfix] Fixed playername display issue on fortress view',
      ],
    },
    {
      version: 'v26-04-07',
